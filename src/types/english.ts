...
export type BuildingId = 'fornalha' | 'bau' | 'cerca' | 'torre' | 'mesa' | 'campinho' | 'arena' | 'cofre' | 'agenda' | 'mercado';
...
export type EnglishSessionGame = EnglishGameId | ContractType | 'redstone';
