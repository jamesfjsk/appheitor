...
export const LEVELS: Record<LevelNumber, EnglishLevel> = {
  1: {
    ...
    noteTemplates: [
      ...
      'Please, I want ___. I am ___.',
      'I put ___ on the ___. I am ready for ___.',
      'Thank you for ___. I like ___.',
      'I wash ___. It is for ___.',
    ],
    noteInfoKinds: [
      'a habit or a polite ask in the present, e.g. "I do my homework", "Please, I want water", "Thank you"',
      'a thing from home, school or football, e.g. "my homework", "the plate", "soccer"',
      'the deal: first / then / for mom / for school / on the chair, e.g. "first", "for mom"',
    ],
  ...
  2: {
    ...
    noteSentences: [2, 3],
    noteTemplates: [
      'Can I ___ now? I can because ___.',
      "I don't want ___ now. I wait because ___.",
      'Please help me with ___. It is hard because ___.',
      'I am sorry. I am late because ___.',
      'I want to ___ after ___. I can wait.',
    ],
    noteInfoKinds: [
      'what you ask, wait or refuse, e.g. "Can I play soccer", "I don\'t want the screen"',
      'a thing from home, school or football, e.g. "soccer", "homework", "dinner", "this word"',
      'a reason with because, e.g. "because my homework is ready", "because dinner is first"',
    ],
  ...
  3: {
    ...
    noteSentences: [3, 3],
    noteTemplates: [
      'I am ___ now. I must ___.',
      'Thank you for ___. I must ___.',
      'I want to ___. I must wait for ___.',
      'I am ___ now. I must sleep to ___.',
      'I am sorry. I must tell ___.',
    ],
    noteInfoKinds: [
      'what is happening now (present continuous), e.g. "I am doing my homework", "I am washing the plate"',
      'a purpose with to + verb, e.g. "to play", "to sleep"',
      'an obligation with must from home life, e.g. "I must wait", "I must help", "I must tell the truth"',
    ],
