  ...
  return (
    <>
      <motion.div
        ...
        className="bg-gradient-to-br from-hero-primary to-hero-secondary rounded-2xl shadow-lg p-6 relative overflow-hidden"
      >
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-hero-accent font-bold">
          ...
          <div className="relative mb-4">
            ...
            <div className="flex justify-between mt-2 text-sm">
              <div className="text-white/80">
                ...
                <div className="text-xs text-white/80">{levelSystem.levelTitle}</div>
              </div>
              {!levelSystem.isMaxLevel && (
                <div className="text-white/80 text-right">
                  ...
                  <div className="text-xs text-white/80">{levelSystem.nextLevelTitle}</div>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center">
              <motion.div
                ...
                className="text-2xl font-bold text-hero-accent flex items-center justify-center gap-1"
              >
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            transition={{ delay: 1 }}
            className="mt-4 p-3 bg-white/20 backdrop-blur-sm border border-white/30 rounded-lg text-center"
          >
            <p className="text-hero-accent text-sm font-bold">
              {!levelSystem.isMaxLevel
