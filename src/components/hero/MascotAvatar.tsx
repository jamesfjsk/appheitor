...
const MascotAvatar: React.FC<MascotAvatarProps> = ({ level, totalXP, isAnimating }) => {
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-hero-primary to-hero-secondary rounded-3xl shadow-lg p-6 text-center"
    >
      {/* Avatar Principal */}
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center justify-center space-x-2 text-hero-accent font-bold">
      ...
      <motion.div
        ...
        className="mt-4 text-hero-accent text-sm font-bold"
      >
