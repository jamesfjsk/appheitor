...
const NOTES_1: OfflineNote[] = [
  {
    ...
    theme: 'a mina',
    content: {
      brief: 'Peça ao ferreiro três tochas e uma picareta. Diga que são para a mina.',
      mustInclude: [
        { pt: 'três tochas', en: ['three torches', '3 torches', 'three torch'] },
        { pt: 'uma picareta', en: ['one pickaxe', 'a pickaxe', '1 pickaxe'] },
        { pt: 'para a mina', en: ['for the mine', 'in the mine', 'to the mine'] },
      ],
      wordBank: ['need', 'torch', 'pickaxe', 'mine', 'for', 'they', 'are', 'have', 'want', 'sword', 'dog', 'and', 'give'],
      model: 'I need three torches and one pickaxe. They are for the mine.',
      hint: '',
    },
  },
  {
    ...
    theme: 'o campinho de futebol',
    content: {
      brief: 'Peça ao ferreiro duas bolas e um apito. Diga que são para o time.',
      mustInclude: [
        { pt: 'duas bolas', en: ['two balls', '2 balls', 'two ball'] },
        { pt: 'um apito', en: ['one whistle', 'a whistle', '1 whistle'] },
        { pt: 'para o time', en: ['for the team', 'to the team', 'for my team'] },
      ],
      wordBank: ['need', 'ball', 'whistle', 'team', 'for', 'they', 'are', 'want', 'have', 'torch', 'cat', 'and', 'give', 'book'],
      model: 'I need two balls and one whistle. They are for the team.',
      hint: '',
    },
  },
  {
    ...
    theme: 'a base',
    content: {
      brief: 'Peça ao ferreiro uma cama vermelha e duas lâmpadas. Diga que são para o seu quarto.',
      mustInclude: [
        { pt: 'uma cama vermelha', en: ['one red bed', 'a red bed', '1 red bed'] },
        { pt: 'duas lâmpadas', en: ['two lamps', '2 lamps', 'two lamp'] },
        { pt: 'para o seu quarto', en: ['for my room', 'in my room', 'for the room'] },
      ],
      wordBank: ['need', 'red', 'bed', 'lamp', 'room', 'for', 'my', 'they', 'are', 'want', 'have', 'chair', 'door', 'and'],
      model: 'I need one red bed and two lamps. They are for my room.',
      hint: '',
    },
  },
  {
    ...
    theme: 'a escola dos mineradores',
    content: {
      brief: 'Peça ao ferreiro cinco lápis e um livro azul. Diga que são para a escola.',
      mustInclude: [
        { pt: 'cinco lápis', en: ['five pencils', '5 pencils', 'five pencil'] },
        { pt: 'um livro azul', en: ['one blue book', 'a blue book', '1 blue book'] },
        { pt: 'para a escola', en: ['for the school', 'for school', 'in the school', 'to the school'] },
      ],
      wordBank: ['want', 'pencil', 'blue', 'book', 'school', 'for', 'they', 'are', 'need', 'have', 'apple', 'table', 'and'],
      model: 'I want five pencils and one blue book. They are for the school.',
      hint: '',
    },
  },
  {
    ...
    theme: 'os animais da vila',
    content: {
      brief: 'Peça ao ferreiro dois ossos e uma corda. Diga que são para o cachorro.',
      mustInclude: [
        { pt: 'dois ossos', en: ['two bones', '2 bones', 'two bone'] },
        { pt: 'uma corda', en: ['one rope', 'a rope', '1 rope'] },
        { pt: 'para o cachorro', en: ['for the dog', 'for my dog', 'to the dog'] },
      ],
      wordBank: ['need', 'bone', 'rope', 'dog', 'for', 'they', 'are', 'have', 'want', 'cat', 'sword', 'and', 'give'],
      model: 'I need two bones and one rope. They are for the dog.',
      hint: '',
    },
  },
  {
    ...
    theme: 'a cozinha',
    content: {
      brief: 'Peça ao ferreiro dez maçãs e um bolo. Diga que são para a festa.',
      mustInclude: [
        { pt: 'dez maçãs', en: ['ten apples', '10 apples', 'ten apple'] },
        { pt: 'um bolo', en: ['one cake', 'a cake', '1 cake'] },
        { pt: 'para a festa', en: ['for the party', 'to the party', 'in the party'] },
      ],
      wordBank: ['want', 'apple', 'cake', 'party', 'for', 'they', 'are', 'need', 'have', 'give', 'banana', 'torch', 'and'],
      model: 'I want ten apples and one cake. They are for the party.',
      hint: '',
    },
  },
];
...
const NOTES_2: OfflineNote[] = [
  {
    ...
    theme: 'a expedição na mina',
    content: {
      brief: 'Peça ao ferreiro quatro tochas para o túnel. Explique que é porque o túnel é escuro.',
      mustInclude: [
        { pt: 'quatro tochas', en: ['four torches', '4 torches', 'four torch'] },
        { pt: 'para o túnel', en: ['for the tunnel', 'in the tunnel', 'to the tunnel'] },
        { pt: 'porque o túnel é escuro', en: ['because the tunnel is dark', 'because it is dark', 'because it is very dark'] },
      ],
      wordBank: ['give', 'torch', 'tunnel', 'dark', 'because', 'for', 'they', 'are', 'need', 'can', 'sword', 'cat', 'want'],
      model: 'Can you give me four torches? They are for the tunnel because it is dark.',
      hint: '',
    },
  },
  {
    ...
    theme: 'o time de futebol',
    content: {
      brief: 'Peça ao ferreiro duas chuteiras para o time. Diga que vocês não conseguem jogar sem elas.',
      mustInclude: [
        { pt: 'duas chuteiras', en: ['two boots', '2 boots', 'two football boots'] },
        { pt: 'para o time', en: ['for the team', 'to the team', 'for my team'] },
        { pt: 'não conseguem jogar sem elas', en: ["we can't play without boots", "we can't play without them", "can't play without"] },
      ],
      wordBank: ['need', 'boot', 'team', 'for', 'we', "can't", 'play', 'without', 'ball', 'want', 'have', 'torch', 'goal'],
      model: "I need two boots for the team. We can't play without boots.",
      hint: '',
    },
  },
  {
    ...
    theme: 'a noite na base',
    content: {
      brief: 'Peça ao ferreiro três lâmpadas para a cozinha. Explique que é porque a cozinha é escura à noite.',
      mustInclude: [
        { pt: 'três lâmpadas', en: ['three lamps', '3 lamps', 'three lamp'] },
        { pt: 'para a cozinha', en: ['for the kitchen', 'in the kitchen'] },
        { pt: 'porque a cozinha é escura', en: ['because the kitchen is dark', 'because it is dark', 'because it is dark at night'] },
      ],
      wordBank: ['want', 'lamp', 'kitchen', 'dark', 'night', 'because', 'for', 'need', 'them', 'have', 'bed', 'chair', 'door'],
      model: 'I want three lamps for the kitchen. I need them because it is dark at night.',
      hint: '',
    },
  },
  {
    ...
    theme: 'a escola dos mineradores',
    content: {
      brief: 'Pergunte ao ferreiro quantos lápis ele tem. Peça seis lápis para a escola e explique que é porque a prova é amanhã.',
      mustInclude: [
        { pt: 'seis lápis', en: ['six pencils', '6 pencils', 'six pencil'] },
        { pt: 'para a escola', en: ['for the school', 'for school', 'to school'] },
        { pt: 'porque a prova é amanhã', en: ['because the test is tomorrow', 'because there is a test tomorrow', 'because the test is on monday'] },
      ],
      wordBank: ['how', 'many', 'pencil', 'have', 'need', 'school', 'because', 'test', 'tomorrow', 'for', 'book', 'apple', 'want'],
      model: 'How many pencils do you have? I need six pencils for the school because the test is tomorrow.',
      hint: '',
    },
  },
  {
    ...
    theme: 'a feira da vila',
    content: {
      brief: 'Peça ao ferreiro uma corda para o cavalo. Diga que o cavalo consegue pular a cerca.',
      mustInclude: [
        { pt: 'uma corda', en: ['one rope', 'a rope', '1 rope'] },
        { pt: 'para o cavalo', en: ['for the horse', 'for my horse', 'to the horse'] },
        { pt: 'o cavalo consegue pular a cerca', en: ['the horse can jump the fence', 'he can jump the fence', 'it can jump the fence', 'can jump the fence'] },
      ],
      wordBank: ['need', 'rope', 'horse', 'fence', 'can', 'jump', 'for', 'because', 'want', 'have', 'dog', 'bone', 'run'],
      model: 'I need one rope for the horse. The horse can jump the fence.',
      hint: '',
    },
  },
  {
    id: 'n2-06',
    level: 2,
    theme: 'a torre de vigia',
    content: {
      brief: 'Peça ao ferreiro cinco maçãs para os mineradores. Explique que é porque eles estão com fome.',
      mustInclude: [
        { pt: 'cinco maçãs', en: ['five apples', '5 apples', 'five apple'] },
        { pt: 'para os mineradores', en: ['for the miners', 'to the miners'] },
        { pt: 'porque eles estão com fome', en: ['because they are hungry', 'because the miners are hungry'] },
      ],
      wordBank: ['give', 'apple', 'miner', 'hungry', 'because', 'for', 'they', 'are', 'can', 'need', 'cake', 'sword', 'want'],
      model: 'Can you give me five apples? They are for the miners because they are hungry.',
      hint: '',
    },
  },
];
...
const NOTES_3: OfflineNote[] = [
  {
    ...
    theme: 'a mina abandonada',
    content: {
      brief: 'Peça ao ferreiro cinco tochas. Diga que são para iluminar o túnel e que a equipe está cavando agora.',
      mustInclude: [
        { pt: 'cinco tochas', en: ['five torches', '5 torches', 'five torch'] },
        { pt: 'para iluminar o túnel', en: ['to light the tunnel', 'for lighting the tunnel', 'to light up the tunnel'] },
        { pt: 'a equipe está cavando', en: ['the team is digging', 'we are digging', 'my team is digging'] },
      ],
      wordBank: ['need', 'torch', 'light', 'tunnel', 'team', 'dig', 'now', 'dark', 'to', 'are', 'is', 'sword', 'cat', 'want'],
      model: 'I need five torches to light the tunnel. The team is digging now. It is very dark.',
      hint: 'Frase 1: quantidade + to + verbo (para quê). Frase 2: is/are + verbo-ing (o que está acontecendo agora).',
    },
  },
  {
    id: 'n3-02',
    ...
    theme: 'o campeonato da vila',
    content: {
      brief: 'Peça ao ferreiro duas redes novas para treinar chutes. Diga que o time deve treinar toda manhã.',
      mustInclude: [
        { pt: 'duas redes', en: ['two nets', '2 nets', 'two net'] },
        { pt: 'para treinar chutes', en: ['for training shots', 'to train shots', 'to practice shots', 'for practicing shots'] },
        { pt: 'o time deve treinar', en: ['the team must train', 'we must train', 'the team must practice'] },
      ],
      wordBank: ['need', 'net', 'train', 'shot', 'team', 'must', 'every', 'morning', 'final', 'for', 'ball', 'torch', 'want'],
      model: 'I need two nets for training shots. The team must train every morning. The final is on Sunday.',
      hint: 'Frase 1: quantidade + for + verbo-ing (para quê). Frase 2: must + verbo (obrigação).',
    },
  },
  {
    id: 'n3-03',
    ...
    theme: 'a tempestade',
    content: {
      brief: 'Peça ao ferreiro três baldes para carregar água. Diga que a chuva está entrando pelo telhado.',
      mustInclude: [
        { pt: 'três baldes', en: ['three buckets', '3 buckets', 'three bucket'] },
        { pt: 'para carregar água', en: ['to carry water', 'for carrying water'] },
        { pt: 'a chuva está entrando', en: ['the rain is coming in', 'rain is coming in', 'the rain is coming', 'water is coming in'] },
      ],
      wordBank: ['need', 'bucket', 'carry', 'water', 'rain', 'come', 'roof', 'fix', 'must', 'to', 'is', 'bed', 'lamp'],
      model: 'I need three buckets to carry water. The rain is coming in through the roof. We must fix it today.',
      hint: 'Frase 1: quantidade + to + verbo. Frase 2: is + verbo-ing (o que está acontecendo agora).',
    },
  },
  {
    id: 'n3-04',
    ...
    theme: 'o dia do torneio',
    content: {
      brief: 'Peça ao ferreiro dez lápis para desenhar o mapa da mina. Diga que os alunos devem terminar o mapa hoje.',
      mustInclude: [
        { pt: 'dez lápis', en: ['ten pencils', '10 pencils', 'ten pencil'] },
        { pt: 'para desenhar o mapa', en: ['to draw the map', 'for drawing the map', 'to draw a map'] },
        { pt: 'os alunos devem terminar', en: ['the students must finish', 'we must finish', 'students must finish'] },
      ],
      wordBank: ['give', 'pencil', 'draw', 'map', 'student', 'finish', 'must', 'today', 'mine', 'to', 'book', 'torch', 'can'],
      model: 'Can you give me ten pencils to draw the map? The students must finish the map today. It is for the mine.',
      hint: 'Frase 1: quantidade + to + verbo (finalidade). Frase 2: must + verbo (obrigação).',
    },
  },
  {
    id: 'n3-05',
    ...
    theme: 'a montanha de gelo',
    content: {
      brief: 'Peça ao ferreiro uma sela nova para montar o cavalo. Diga que o cavalo está correndo mais rápido agora.',
      mustInclude: [
        { pt: 'uma sela', en: ['one saddle', 'a saddle', '1 saddle', 'a new saddle'] },
        { pt: 'para montar o cavalo', en: ['to ride the horse', 'for riding the horse', 'to ride my horse'] },
        { pt: 'o cavalo está correndo', en: ['the horse is running', 'my horse is running', 'he is running', 'it is running'] },
      ],
      wordBank: ['need', 'saddle', 'ride', 'horse', 'run', 'fast', 'now', 'old', 'small', 'to', 'is', 'dog', 'bone'],
      model: 'I need a new saddle to ride the horse. The horse is running faster now. The old saddle is too small.',
      hint: 'Frase 1: a + item + to + verbo. Frase 2: is + verbo-ing + comparativo (faster).',
    },
  },
  {
    id: 'n3-06',
    ...
    theme: 'o mercado noturno',
    content: {
      brief: 'Peça ao ferreiro quatro panelas para cozinhar a sopa. Diga que o cozinheiro está esperando.',
      mustInclude: [
        { pt: 'quatro panelas', en: ['four pots', '4 pots', 'four pot'] },
        { pt: 'para cozinhar a sopa', en: ['to cook the soup', 'for cooking the soup', 'to cook soup', 'for cooking soup'] },
        { pt: 'o cozinheiro está esperando', en: ['the cook is waiting', 'the chef is waiting', 'he is waiting'] },
      ],
      wordBank: ['need', 'pot', 'cook', 'soup', 'wait', 'kitchen', 'miner', 'hungry', 'always', 'to', 'is', 'are', 'cake', 'bread'],
      model: 'I need four pots to cook the soup. The cook is waiting in the kitchen. The miners are always hungry.',
      hint: 'Frase 1: quantidade + to + verbo (para quê). Frase 2: is + verbo-ing (agora). Frase 3: livre, com always ou never.',
    },
  },
];
