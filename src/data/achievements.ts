...
export const GAME_ACHIEVEMENTS: GameAchievement[] = [
  ...
  a('primeiro_livro', 'biblioteca', 'bronze', 'Primeiro livro', 'Contou um livro ao Sábio.', 'book', 'booksRead', 1),
  a('cinco_livros', 'biblioteca', 'prata', 'Cinco livros', 'Cinco livros na estante.', 'book', 'booksRead', 5),
  a('doze_livros', 'biblioteca', 'ouro', 'Doze livros', 'Uma estante cheia.', 'book', 'booksRead', 12),
