...
| `src/services/quiz/validateQuestion.ts` (+ `src/services/quiz/__tests__/validateQuestion.test.ts`, `fixtures/era3.json`) | etapa-3 p6 | P0.2 / 28 RejectCodes | `aiDailyQuiz`, `reviewer` | prova v3 (lei do professor) |
...
| `src/services/aiCost.ts` | etapa-3 p5 | P0.7 teto e preço gpt-4o | `aiUsage`, painel | não ensina |
...
| `docs/exemplos/telas/etapa-3/prova/` (+ `_shot_prova.mjs`) | etapa-3 p1 | lei / aceite visual | lição, anel, reflexão com saída | prova do dia (Etapa 2, §22) |
