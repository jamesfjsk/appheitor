...
- **Duas portas** (`docs/MUNDO.md`, seção 5): lugar = quadro clicável, sem andar; jogos (tabuleiro e ação) abrem em tela cheia com Phaser 2D + HUD React; Arena = tabuleiro vivo, não modal da Vila; Fazenda = lugar, não rush. Sem Unity/Godot no app. Molde: Redstone da Mina. Etapa 4 e 4B.
...
Regra geral (15/09): no fim, passada educacional módulo por módulo (Etapa 5B do roadmap): ficha pedagógica conferida, dados reais lidos, conteúdo de IA amostrado e revisado pelo pai, sessão observada com o Heitor, lista de ajustes. Todo módulo novo que ensina algo nasce com a ficha.
| (novo) Arena | jogos de raciocínio contra os pais: xadrez, damas, Lig 4, batalha naval, duelo de perguntas; por turnos, cada um no seu aparelho, com "sua vez" por push; XP e material, nunca gold; troféu na Torre; o Olheiro é o dono | cartão "Em breve" na Etapa 2; jogos de verdade na Etapa 4B, um por entrega, testado com o pai antes |
| Conquistas só as que o pai cria (Torre vazia) | não há "quase lá" no jogo; conquista de vida real e de jogo misturadas | **Conquistas do jogo** (`docs/VILA_CONQUISTAS.md`): catálogo de 72 em 10 categorias com contadores automáticos, camadas bronze/prata/ouro/exclusiva, escondidas, "Quase lá" na Torre, XP e material (nunca gold); as da vida real ficam separadas, do pai, com gold se ele quiser | Etapa 2, Lote 2 (seção 19) |
| (novo) Mundo e Fazenda | a Vila vai ficar pequena; jogo estático sem viagem | **Mundo** (`docs/MUNDO.md`): mapa pintado com regiões (Vila, Mina, Fazenda, Biblioteca, Arena, Montanha, Praia, Castelo), cenas pelo mesmo motor, transição com o minerador andando, regiões fechadas com névoa e placa como metas; **Fazenda** na pegada de Fazenda Feliz: plantar com material, regar pelo dia completo, colher em dias reais, animais dos pets, níveis próprios | regra de cena como dado desde o Lote 2; Biblioteca e Mina como cenas na Etapa 3; mapa e Fazenda na Etapa 4 |
| (novo) Motor gráfico / “tudo vira Vila” | a cena é pintura; vários jogos no roteiro nasceriam como o mesmo clique | **Duas portas** (`docs/MUNDO.md`, seção 5): Vila e mapa continuam quadro (menos erro no tablet); jogos abrem em tela cheia no Phaser 2D (molde: Redstone da Mina); Arena é tabuleiro vivo; Fazenda não vira Stardew. Sem motor 3D no app | decisão 16/09; kit de ação na Etapa 4; tabuleiro na Etapa 4B |
