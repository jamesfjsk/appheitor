...
- **É a casa do Ferreiro.** O distrito "Oficina" vira **Ferraria**: o Ferreiro (sprite `npc/ferreiro.png`, fala pelo sistema de diálogos) na cena ao lado da Fornalha; tocar nele ou no cartão da grade abre a Ferraria. Abas: **Forjar** (equipamentos), **Fundição** (a troca 3 por 1, liberada pela Fornalha nível 2; antes disso a aba mostra "A Fornalha nível 2 libera a Fundição") e **Obras** (visão geral das sete construções, só leitura, cada linha abre o cartão da construção). A aba "Construir" some: construir é no cartão de cada construção.
